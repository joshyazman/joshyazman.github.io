...
<p>
  <img src="https://joshyazman.github.io/images/josh-and-lb-vote-shirt.png#center" width = "500" height = "400"/>
</p>
...
Previously, I advised a local candidate in New York who won a strong re-election despite his district swinging 9 points from Obama to Trump in 2016. My team determined the candidate's underlying support levels, studied the electoral environment in the district, and developed a suite of individual-level models of voter behavior to most efficiently target messaging. 

## Committees and Independent Expenditures  
My first project at BlueLabs was to work as an embedded consultant to the DSCC analytics director. In that capacity I helped coordinate the delivery and implementation of analytics assets including individual models and polls, administering access to key tools like the Civis Platform and Votebuilder, and coaching state data directors on how to implement those models and tools in their programs.

Between federal cycles, I worked with one of the largest independent expenditures investing in Virginia state house races. I worked with them to identify the most competitive races where outside resources could be most impactful. The goal was to support the candidates most likely to help Democrats flip the balance of their chamber to support actions to solve climate change.

## Voter Registration Targeting
Unregistered voters are, by definition, very difficult to find on voter files. I led the development of a product at BlueLabs called *Tallia* which does just this. My team compared US Census Bureau data with data from the voter file to identify which Census blocks, zip codes, counties, and districts presented the best opportunities to grow Democratic vote share through registration. As part of this project I also wrote a detailed memo on existing research into tactics and effects of voter registration activities, which was distributed to a number of grantee organizations supported by the main project funder. 

In campaigns, we directly implemented learnings from this targeting work to identify the most efficient voter registration targets in key Senate races in 2020 for digital outreach as well as field (when viable) and mail.

As a twist on this work I also helped the National Low Income Housing Coalition (NLIHC) develop and deploy individual-level data assets to their network of property managers to register voters at participating housing complexes. This project sought to directly empower residents in subsidized housing by ensuring they were able and ready to participate in the 2020 elections. My contribution was to help design data intake templates, build a data pipeline to support over 25 participating organizations, and develop custom lists of currently registered voters to the client in a format that they could cross-reference with residency lists to target outreach.
